...
const createRecentlyPlayedPlaylistCard = (recentlyPlayedContainer) => {
  ...
  recentlyPlayedPlaylistCard.setAttribute("class", "recently-played-playlist-card d-flex");
  ...
  recentlyPlayedPlaylistImgContainer.classList.add("recently-played-playlist-img-container");
  ...
  recentlyPlayedPlaylistCardInfoContainer.setAttribute("class", "bg-dark d-flex justify-content-center align-items-center p-5");
  recentlyPlayedPlaylistCard.appendChild(recentlyPlayedPlaylistCardInfoContainer);
  ...
  recentlyPlayedPlaylistCardInfoContainer.appendChild(recentlyPlayedPlaylistCardTitle);
...
const createRecentlyPlayedCard = (recentlyPlayedContainer) => {
  ...
  recentlyPlayedImgContainer.setAttribute("class", "recently-played-img-container");
  recentlyPlayedCard.appendChild(recentlyPlayedImgContainer);

  const recentlyPlayedCardImg = document.createElement("img");
  recentlyPlayedCardImg.src = "https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da840c489c9523ae48b2c3d96177";
  ...
  recentlyPlayedCardInfoContainer.setAttribute("class", "bg-dark d-flex justify-content-center align-items-center p-5");
...
const createMainPlaylistCard = (container) => {
  ...
  playlistCard.setAttribute("class", "playlist-card bg-dark d-flex flex-column justify-content-center align-items-start gap-3");
  playlistCardWrapper.appendChild(playlistCard);

  const playlistCardImgContainer = document.createElement("div");
  playlistCardImgContainer.setAttribute("class", "playlist-card-img-container w-100");
  ...
  playlistCardInfoContainer.setAttribute("class", "playlist-card-info-container d-flex flex-column");
  playlistCard.appendChild(playlistCardInfoContainer);

  const playlistCardInfoTitle = document.createElement("h4");
  playlistCardInfoTitle.setAttribute("class", "playlist-title-card fs-6 text-white fw-bold");
  ...
  playlistCardInfoDescription.setAttribute("class", "playlist-card-description text-secondary m-0");
...
>>>>>>> d7e3fb2da0cedb5eec85a5fc5d76310f0a6000b1
